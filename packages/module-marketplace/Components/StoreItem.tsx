      ...
      >
        ...
        >
          <Grid item container>
            ...
            <Grid item container>
              <Thumbnail
                className="w-8 h-8 p-1 mb-[-1rem] lg:mb-[-1.595rem] xl:mb-[-1.895rem] bg-white group-hover:scale-[1.02] duration-300 border border-solid translate-x-[0.6rem] translate-y-[-1rem] lg:translate-y-[-1.8rem] xl:translate-y-[-1.7rem] rounded-lg lg:h-12 lg:w-12 border-colorBorder"
                style={{
                  position: 'relative',
                }}
                thumbnail={
