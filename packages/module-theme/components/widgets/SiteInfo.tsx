...
const SiteInfo = ({ items }: { items: Benefit[] | any }) => {
  return (
    <div className="2xl:max-w-[90rem] lg:mx-auto">
      <div className="py-11 px-6 lg:even:divide-y-0 gap-y-6 lg:divide-x justify-start lg:justify-center lg:divide-y-0 lg:divide-solid lg:divide-[#d2d2d2] text-black grid sm:grid-cols-2 lg:grid-cols-4  [&:nth-child(2)]:min-h-[16.68rem]">
