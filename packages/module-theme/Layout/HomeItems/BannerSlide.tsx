      ...
      <div className="absolute top-[47%] max-w-[90rem] max-h-fit mx-auto bottom-0 px-3 z-10 flex items-center justify-between w-full">
        {items.length >= 2 && (
          <button
            ...
            className="relative items-center justify-center hidden w-12 h-12 ml-1 duration-300 bg-white border-0 rounded-full cursor-pointer hover:scale-105 hover:shadow-xl 2xl:-ml-1 md:flex"
        ...
        {items.length >= 2 && (
          <button
            ...
            className="hidden bg-white rounded-full hover:scale-105 duration-300 hover:shadow-xl items-center justify-center h-12 w-12 cursor-pointer mr-1.5 2xl:ml-6 border-0 top-2.5 md:flex"
